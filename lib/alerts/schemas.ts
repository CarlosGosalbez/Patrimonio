...
export const customAlertInputSchema = z
  .object({
    ...
    dismissed_until: z.union([dateString, z.literal(''), z.null(), z.undefined()]).transform((value) => {
      if (!value) {
        return null
      }
...
export const customAlertPatchSchema = z
  .object({
    ...
    dismissed_until: z.union([dateString, z.literal(''), z.null(), z.undefined()]).optional().transform((value) => {
