  ...
  return (
    ...
    >
      <div className="flex items-center gap-3">
        <button
          type="button"
          className="touch-none cursor-move p-1 hover:bg-accent rounded-md focus-visible:ring-2"
          {...attributes}
          {...listeners}
        >
        ...
        {color && (
          <div className="h-6 w-6 rounded-full flex-shrink-0" style={{ backgroundColor: color }} />
        )}
