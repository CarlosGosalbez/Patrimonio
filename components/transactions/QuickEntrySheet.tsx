...
const QuickEntrySchema = z.object({
    ...
    description: safeString(500).min(1),
                            ...
                            <div role="group" aria-label={t("quickEntry.type")}>
                                <div className="grid grid-cols-2 gap-2">
                                    <button
                                        ...
                                        className={`flex min-h-[44px] items-center justify-center gap-2 rounded-xl border-2 font-medium transition-colors focus-visible:ring-2 ${!isIncome
