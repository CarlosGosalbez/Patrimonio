        ...
        return (
            <Card className="shadow-xl shadow-slate-200/50 dark:shadow-slate-900/50 border-0">
                ...
                <CardContent className="text-center">
                    <p className="text-sm text-muted-foreground mb-4">{t('spamNotice')}</p>
                    <a href="/login" className="text-primary text-sm font-medium hover:underline focus-visible:ring-2 focus-visible:ring-ring rounded">
                        {t('goToLogin')}
                    </a>
                </CardContent>
            </Card>
            ...
            <CardContent>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-4" noValidate>
                    ...
                    <p className="text-xs text-center text-muted-foreground">
                        {t('terms')}{' '}
                        <a href="/terms" className="text-primary hover:underline focus-visible:ring-2 focus-visible:ring-ring rounded">
                            {t('termsLink')}
                        </a>
                        {' '}{t('and')}{' '}
                        <a href="/privacy" className="text-primary hover:underline focus-visible:ring-2 focus-visible:ring-ring rounded">
                            {t('privacyLink')}
                        </a>.
                    </p>
                </form>
                ...
                <div className="mt-5 text-center text-sm text-muted-foreground">
                    {t('hasAccount')}{' '}
                    <a href="/login" className="text-primary font-medium hover:underline focus-visible:ring-2 focus-visible:ring-ring rounded">
                        {t('signIn')}
                    </a>
                </div>
            </CardContent>
