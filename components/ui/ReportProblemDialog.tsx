        ...
        <form className="space-y-4" onSubmit={(e) => void handleSubmit(e)}>
          ...
          {success && (
            <p
              role="status"
              aria-live="polite"
              className="rounded-2xl bg-emerald-500/10 px-4 py-3 text-sm text-emerald-700 dark:text-emerald-400"
            >
              {t("successToast")}
            </p>
          )}
          ...
          <Button type="submit" className="min-h-[44px] w-full" disabled={saving || success}>
