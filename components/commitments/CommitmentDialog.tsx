...
const TYPE_VISIBILITY: Record<CommitmentType, {
  ...
  mortgage: { accountRequired: true, showCancelledAt: false, showMortgageFields: true, showServiceName: false, showToleranceDays: false },
  rent_income: { accountRequired: false, showCancelledAt: false, showMortgageFields: false, showServiceName: false, showToleranceDays: true },
  rent_expense: { accountRequired: true, showCancelledAt: false, showMortgageFields: false, showServiceName: false, showToleranceDays: false },
  subscription: { accountRequired: true, showCancelledAt: true, showMortgageFields: false, showServiceName: true, showToleranceDays: false },
  tax: { accountRequired: true, showCancelledAt: false, showMortgageFields: false, showServiceName: false, showToleranceDays: false },
  insurance: { accountRequired: true, showCancelledAt: true, showMortgageFields: false, showServiceName: true, showToleranceDays: false },
  utility: { accountRequired: true, showCancelledAt: false, showMortgageFields: false, showServiceName: true, showToleranceDays: false },
  other: { accountRequired: false, showCancelledAt: true, showMortgageFields: false, showServiceName: true, showToleranceDays: true },
}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) => setState((current) => ({ ...current, amount_input: event.target.value }))}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) => setState((current) => ({ ...current, next_due_date: event.target.value }))}
                />
              </div>
              ...
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) => setState((current) => ({ ...current, start_date: event.target.value }))}
                />
              </div>
            </div>
              ...
              <div className="flex items-center justify-between">
                <Label htmlFor="commitment-account">
                  ...
                  {!visibility.accountRequired ? (
                    <span className="ml-1 text-xs text-muted-foreground">({t('fields.optional')})</span>
                  ) : null}
                </Label>
                {accounts.length === 0 ? (
                  <button
              ...
              <div className="grid gap-4 rounded-2xl border border-border/60 bg-muted/20 p-4 md:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(event) => setState((current) => ({ ...current, maturity_year: event.target.value }))}
                  />
                </div>
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={(event) => setState((current) => ({ ...current, interest_rate_input: event.target.value }))}
                  />
                </div>
                <label className="flex min-h-[44px] items-center gap-2 rounded-2xl border border-border/60 px-4 py-3 text-sm md:col-span-2">
                  <input
                    ...
                    onChange={(event) => setState((current) => ({ ...current, allows_early_repayment: event.target.checked }))}
                  />
            ...
            {visibility.showServiceName ? (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) => setState((current) => ({ ...current, service_name: event.target.value }))}
                />
              </div>
            ) : null}
            ...
            {visibility.showCancelledAt ? (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) => setState((current) => ({ ...current, cancelled_at: event.target.value }))}
                />
              </div>
            ) : null}
            ...
            {visibility.showToleranceDays ? (
              <div className="space-y-2">
                ...
                <Input
                  ...
                  onChange={(event) =>
                    setState((current) => ({ ...current, tolerance_days: Number(event.target.value) }))
                  }
                />
              </div>
            ) : null}
            ...
            <div className="flex flex-wrap gap-3">
              <label className="flex min-h-[44px] items-center gap-2 rounded-2xl border border-border/60 px-4 py-3 text-sm">
                <input
                  ...
                  onChange={(event) => setState((current) => ({ ...current, is_automated: event.target.checked }))}
                />
